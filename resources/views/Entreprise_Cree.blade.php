...
<head>
    ...
    <title>Entreprise_cree_Valide</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/css/bootstrap.min.css" rel="stylesheet">
    <link href="style_100.CSS" rel="stylesheet">
...
<header class="d-flex align-items-center text-white py-2">
    ...
    <div class="logo-container1 d-flex align-items-center justify-content-center bg-white me-3"
        ...
        <img src="icons/0 2.png" alt="Logo gauche" class="img-fluid">
    </div>
    ...
    <div class="links d-flex align-items-center">
        <a href="#" class="text-white d-flex align-items-center me-3">
            <img src="icons/info-circle-fill.svg" alt="Info" class="icon-white me-1" style="width: 20px; height: 20px;"
                class="me-1"> Accès rapide
        </a>
        <span class="text-white">|</span>
        <a href="#" class="text-white d-flex align-items-center mx-3">
            <img src="icons/snow3.svg" alt="Observatoire" class="icon-white me-1" style="width: 20px; height: 20px;"
                class="me-1"> Observatoire
        </a>
        <span class="text-white">|</span>
        <a href="#" class="text-white d-flex align-items-center ms-3">
            <img src="icons/person-fill.svg" alt="Person" class="icon-white me-1" style="width: 20px; height: 20px;"
    ...
    <div class="logo-container1 d-flex align-items-center justify-content-center bg-white ms-3"
        style="height: 73px; width: 73px;">
        <img src="icons/logoINSTI 1.png" alt="Logo droite" class="img-fluid">
    </div>
</header>
...
<section class="gallery-header position-relative">
    ...
    <div class="header-image">
        <img src="images/DSC_0196 1.png" class="d-block w-100" alt="Galeries">
    </div>
</section>

<div class="container00">
    <div class="main-content">
        <img src="images/img_actu.png" alt="Lancement AppDev229" class="event-image">
        <div class="content" style="margin-bottom: 55px;">
            ...
            <p>AppDev229, une startup prometteuse créée dans le cadre du programme Entreprendre à l'École, 
                ...
                <button class="read-more"><a href="entreprisecree_LirePlus.html" class="lien"><strong>Lire plus </strong></a><img src="icons/weui_eyes-on-filled.png" alt="lire+"></button>
        </div>
        <img src="images/img_actu.png" alt="Lancement AppDev229" class="event-image">
        <div class="content" style="margin-bottom: 55px;">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="mt-3">
                    ...
                    <a href="https://facebook.com" target="_blank" class="text-white me-3">
                        <img src="icons/facebook.svg" alt="Facebook" class="icon-white me-1"
                            style="width: 40px; height: 40px;">
                    </a>
                    <!-- Icône YouTube -->
                    <a href="https://youtube.com" target="_blank" class="text-white me-3">
                        <img src="icons/youtube.svg" alt="YouTube" class="icon-white me-1"
                            style="width: 40px; height: 40px; ">
                    </a>
                </div>
            ...
            <div class="col-md-4">
                <h5>LIENS UTILES</h5>
                <ul class="list-unstyled">
                    <li><a href="#" class="text-white text-decoration-none">Ministère de l'Enseignement Supérieur et de
                    ...
                    <li><a href="#" class="text-white text-decoration-none">Institut National Supérieur de Technologie
                            Industrielle</a></li>
                </ul>
            </div>
        </div>
